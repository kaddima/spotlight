...
export default function CreateScreen() {
	...
	const generateUploadUrl = useMutation(api.mutation.posts.generateUploadUrl);
	const createPosts = useMutation(api.mutation.posts.createPosts);
	...
	return (
		...
		>
			<View style={styles.contentContainer}>
				...
				>
					<View style={[styles.content, isSharing && styles.contentDisable]}>
						{/* Image section */}
